...
export default function MentorOnboarding({
  ...
  const validateStep = (step: number): boolean => {
    ...
    if (step === 1) {
      ...
      else if (formData.shortBio.length < 50)
        newErrors.shortBio = "Bio should be at least 50 characters";
    ...
    if (step === 2) {
      ...
      if (formData.preferredStudentLevels.length === 0)
        newErrors.preferredStudentLevels =
          "Please select at least one student level";
    }
    ...
    if (step === 3) {
      ...
      if (
        formData.githubPortfolio &&
        !formData.githubPortfolio.startsWith("http")
      ) {
    ...
    <div className="p-6 max-w-2xl mx-auto max-h-[80vh] overflow-y-auto">
      ...
      {hasExistingSubmission && (
        <Alert className="mb-6">
          ...
          <AlertDescription>
            We found a previous application. You can continue where you left off
            or start fresh.
            <Button
              variant="link"
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) =>
                updateFormData("professionalRole", e.target.value)
              }
            ...
            {errors.professionalRole && (
              <p className="text-red-500 text-sm">{errors.professionalRole}</p>
            )}
          </div>
        </div>
      )}
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) =>
                updateFormData("teachingExperience", value)
              }>
              <SelectTrigger
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) =>
                updateFormData("linkedinProfile", e.target.value)
              }
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) =>
                updateFormData("githubPortfolio", e.target.value)
              }
            ...
            {errors.githubPortfolio && (
              <p className="text-red-500 text-sm">{errors.githubPortfolio}</p>
            )}
          </div>
              ...
              {formData.profilePicturePreview ? (
                <div className="space-y-4">
                  ...
                  <Button
                    type="button"
                    variant="outline"
                    onClick={() => updateFormData("profilePicturePreview", "")}>
